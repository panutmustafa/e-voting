...
<body class="min-h-screen bg-slate-950 text-slate-100">
  <div class="mx-auto max-w-6xl px-6 py-16">
    <a href="/e-voting/index.php?page=home" class="mb-8 inline-flex rounded-full border border-slate-700 px-4 py-2 text-sm">← Kembali</a>
    <div class="overflow-hidden rounded-3xl border border-white/10 bg-slate-900/80 shadow-2xl lg:grid lg:grid-cols-[0.85fr_1.15fr]">
      <img src="/e-voting/<?php echo htmlspecialchars($candidate['photo'] ?: 'uploads/default.png'); ?>" alt="<?php echo htmlspecialchars($candidate['name']); ?>" class="h-full w-full object-cover" onerror="this.src='/e-voting/uploads/default.png'; this.style.objectFit='contain'; this.style.padding='2rem'; this.style.background='#0f172a'">
