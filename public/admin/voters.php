...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['create_voter'])) {
        ...
        $qrPayload = $protocol . $httpHost . '/e-voting/public/vote.php?voter_number=' . urlencode($voterNumber) . '&token=' . urlencode($token);
    ...
    header('Location: /e-voting/public/admin/voters.php');
    exit;
}
    ...
    <div class="rounded-3xl border <?php echo $theme === 'dark' ? 'border-slate-800 bg-slate-900' : 'border-slate-200 bg-white'; ?> p-6">
      ...
      <div class="mt-6 rounded-2xl border <?php echo $theme === 'dark' ? 'border-slate-700 bg-slate-900/50' : 'border-slate-200 bg-slate-50'; ?> p-5">
        <div class="flex items-center justify-between">
          ...
          <a href="/e-voting/public/admin/templates/voters_template.csv" class="text-xs font-semibold text-blue-500 hover:underline">Download Template</a>
        </div>
            ...
            <?php foreach ($voters as $voter): ?>
              <tr class="border-t <?php echo $theme === 'dark' ? 'border-slate-800' : 'border-slate-200'; ?>">
                ...
                <td class="px-3 py-3">
                  ...
                  <a href="/e-voting/public/admin/voter_card.php?id=<?php echo (int)$voter['id']; ?>" class="ml-2 text-blue-500 hover:underline">Lihat Kartu</a>
                </td>
