...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['create_candidate'])) {
        ...
        header('Location: /public/admin/candidates.php');
        exit;
...
<div class="flex min-h-screen">
  ...
  <main class="flex-1 p-8 pt-16 lg:pt-8">
    <div class="rounded-3xl border <?php echo $theme === 'dark' ? 'border-slate-800 bg-slate-900' : 'border-slate-200 bg-white'; ?> p-6">
      ...
      <form method="post" action="/public/admin/candidates.php" enctype="multipart/form-data" class="mt-8 grid gap-4 md:grid-cols-2">
        <?php csrf_field(); ?>
      ...
      <div class="mt-8 grid gap-4 md:grid-cols-2 xl:grid-cols-3">
          ...
          <div class="overflow-hidden rounded-3xl border <?php echo $theme === 'dark' ? 'border-slate-800 bg-slate-950' : 'border-slate-200 bg-slate-50'; ?>">
            <img src="/<?php echo htmlspecialchars($candidate['photo'] ?: 'uploads/default.png'); ?>" class="h-48 w-full object-cover" onerror="this.src='/uploads/default.png'; this.style.objectFit='contain'; this.style.padding='2rem'; this.style.background='#1e293b'">
            <div class="p-5">
